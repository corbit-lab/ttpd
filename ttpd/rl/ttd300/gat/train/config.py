...
class PPOConfig:
    pomo_size: int = 32
    n_sample_power: float = 1.0   
    anchor_sizes: tuple = (10, 20)
    ...
    normalise_entropy: bool = True
    min_lr: float = 2e-5
    extend_peak_lr: float = 6e-5
    target_kl: float = 0.02           # early-stop the update epoch when mean KL exceeds 1.5x this
